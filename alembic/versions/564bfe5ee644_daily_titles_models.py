...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["chat_id"],
            ["daily_titles_group_chats.chat_id"],
            name=op.f(
                "fk_daily_titles_inevitable_titles_chat_id_daily_titles_group_chats"
            ),
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "is_missing", sa.Boolean(), server_default=sa.false(), nullable=False
        ),
        sa.ForeignKeyConstraint(
            ["chat_id"],
            ["daily_titles_group_chats.chat_id"],
        ...
        sa.UniqueConstraint(
            "user_id", "chat_id", name=op.f("uq_daily_titles_participants_user_id")
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["daily_titles_group_chats.chat_id"],
            name=op.f(
                "fk_daily_titles_shuffled_titles_chat_id_daily_titles_group_chats"
            ),
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
    ...
    with op.batch_alter_table("daily_titles_shuffled_titles", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_daily_titles_shuffled_titles_roll_order"),
            ["roll_order"],
            unique=False,
        )
